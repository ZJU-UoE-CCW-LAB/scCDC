...
#' @return a matrix containing expression percent results with gene names as row names,
...
#' @param type a parameter setting for whether to use 'data' slot or 'counts' slot in the Seurat object to calculate average expression
#' "default" for calculation using 'counts' slot.
#'
#' @return a matrix containing average expression results with gene names as row names,
#' cluster names as column names.
#'
#' @import Seurat
#' @import pbapply
...
#' @param genes If specified a vector of genes, only these genes would be labeled on the plot. If not specified,
#' the significantly deviated genes in the dataset would be labeled.
